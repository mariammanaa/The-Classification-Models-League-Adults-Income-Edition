...
# 🏆 The Classification Models League: Adult Income Edition

A comparative benchmarking of 6 machine learning classification models (RF, Logistic Regression, SVM, KNN, Decision Trees, Naive Bayes) predicting individual income levels (>50K vs <=50K) using the UCI Adult Census Income dataset.
